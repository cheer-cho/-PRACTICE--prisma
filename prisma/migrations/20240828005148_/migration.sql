/*
  ...
  - A unique constraint covering the columns `[age,firstName,lastName]` on the table `User` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "User_age_firstName_lastName_key" ON "User"("age", "firstName", "lastName");
